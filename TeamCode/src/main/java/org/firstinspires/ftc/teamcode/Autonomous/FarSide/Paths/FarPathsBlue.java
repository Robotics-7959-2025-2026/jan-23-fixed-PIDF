...
public class FarPathsBlue extends FarPaths {
    ...
    public FarPathsBlue(Follower follower) {
        shootPre = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(110), maxRotTimeShoot)
        ...
        grabOne = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(110), Math.toRadians(-150), maxRotTimeGrab)
        ...
        shootOne = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(-150), Math.toRadians(110), maxRotTimeShoot)
        ...
        grabTwo = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(110), Math.toRadians(180), maxRotTimeGrab)
        ...
        shootTwo = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(110), maxRotTimeShoot)
